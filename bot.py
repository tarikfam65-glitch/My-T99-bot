...
"""
ShadowNet v14.0 - الكود النهائي (جميع الأخطاء محلولة)
- تم إصلاح 409 تلقائياً
...
# بقية دوال build_* موجودة في الكود السابق...
...
def callback_handler(call):
    try:
        ...
        # ===== باقي الأزرار (مختصرة للطول) =====
        # ... (جميع الأزرار الأخرى تعمل بنفس النمط)
...
# ===================== تشغيل البوت (محسّن ضد 409) =====================
def start_bot():
    """تشغيل البوت مع إعادة محاولة تلقائية لجميع الأخطاء"""
    while True:
        try:
            # 1. حذف الـ Webhook
            try:
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🤖 ShadowNet + T11 - النسخة النهائية (جميع الأخطاء محلولة)")
