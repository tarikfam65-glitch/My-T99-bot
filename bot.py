...
"""
ShadowNet Framework v11.0 - النسخة النهائية المستقرة
    ...
    try:
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            if info:
                ...
                # إذا لم نجد الملف، حاول استخدام اسم الملف من info
                if not found_file:
                ...
                if found_file:
                    ...
                    # البحث عن أي ملف في مجلد التحميلات
...
# ===================== معالج الأزرار (المختصر للقوائم المشتركة) =====================
