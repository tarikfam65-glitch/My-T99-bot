...
"""
ShadowNet Framework v14.0 - الكود النهائي المصحح بالكامل (الجزء الأول)
تم إصلاح: ISLAMIC_DATA, QUOTES_ARABIC, QUOTES_ENGLISH, TIPS, add_command, جميع الدوال المفقودة
...
# ===================== دوال الحماية =====================
def active_shield():
    return "🛡️ درع الحماية مفعل: يتم تطبيق حد الطلبات ومنع الـ IPs المشبوهة"
...
def restart_bot_safely():
    ...
    return "✅ تم تسجيل إعادة التشغيل الآمنة"
