...
"""
ShadowNet v14.0 - الكود النهائي (مع إغلاق النسخ القديمة تلقائياً)
- يحل خطأ 409 تلقائياً
- يغلق أي نسخة قديمة من البوت
- إعادة محاولة قوية
"""
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🤖 ShadowNet + T11 - النسخة النهائية (مع إغلاق النسخ القديمة)")
