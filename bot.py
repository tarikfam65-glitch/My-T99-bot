...
import builtwith
import threading
import requests as req_lib  # لإرسال طلبات الـ Keep-alive
...
SERVER_URL = os.environ.get('SERVER_URL', 'https://my-t99-bot.onrender.com')  # اضبط الرابط الصحيح
...
def keep_alive():
    """
    يرسل طلباً للمسار /ping كل 5 دقائق للحفاظ على نشاط التطبيق.
    """
