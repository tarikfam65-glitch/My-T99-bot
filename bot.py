...
TIPS = {
    'دراسية': ["خصص وقتاً منتظماً للمذاكرة يومياً، فالاستمرارية أهم من الكمية.", "راجع دروسك قبل النوم لترسيخ المعلومات في الذاكرة طويلة المدى.", "استخدم تقنية البومودورو للتركيز: 25 دقيقة عمل و5 دقائق راحة.", "اكتب ملخصاتك بيدك لتثبيت المعلومة، فالكتابة تعزز الحفظ."],
    'اجتماعية': ["كن صادقاً مع أصدقائك في كل الأوقات، فالصدق أساس العلاقات الناجحة.", "استمع أكثر مما تتحدث، فالاستماع الجيد يجعلك تتعلم وتفهم الآخرين.", "الاحترام المتبادل أساس العلاقات الناجحة، عامِل الناس كما تحب أن يعاملوك.", "ساعد الآخرين دون انتظار مقابل، فالعطاء الحقيقي هو عطاء الروح."],
    'للاكتئاب': ["لا تيأس، فالحياة جميلة وسوف تشرق شمس جديدة كل صباح.", "اطلب المساعدة من المقربين، لا تتحمل الألم وحدك فالدعم يساعدك.", "تذكر أن هذه الأيام ستمر، والألم سيخفف مع الوقت والصبر.", "اهتم بنفسك، فصحتك النفسية مهمة، خصص وقتاً للاسترخاء."],
    'إسلامية': ["توكل على الله في كل أمورك، فهو خير وكيل ونعم المولى ونعم النصير.", "أكثر من الاستغفار، فهو يفتح أبواب الرزق ويغسل الذنوب.", "الصبر مفتاح الفرج، فلا تيأس من رحمة الله، فمع العسر يسراً.", "ذكر الله يطمئن القلوب، فأكثر من تسبيحه وتحميده وتكبيره."]
}
