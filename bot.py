...
# ===================== دوال الخدمات (مع إصلاح Gemini و IMAGE_PROCESS_FAILED) =====================

# 1. Gemini AI (تم تغيير النموذج إلى gemini-pro)
def get_gemini_response(user_text):
    try:
        ...
        # ✅ استخدام gemini-pro (نموذج مستقر ومتاح دائماً)
...
# 2. توليد الصور (مع حفظ محلي وحذف مؤقت)
...
def handle_callback(call):
    ...
    # ===== إنشاء الصور (باستخدام الدالة الجديدة) =====
    if data == "mode_image":
        if is_admin(chat_id):
