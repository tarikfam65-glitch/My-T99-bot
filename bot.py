...
"""
ShadowNet Framework v6.1 - النظام المتكامل للاختبارات الأمنية والقرصنة الأخلاقية
جميع الميزات تعمل بشكل حقيقي مع دعم Render
"""
...
# مفاتيح API الخارجية (ضبطها في متغيرات البيئة)
VIRUSTOTAL_API_KEY = os.environ.get('VIRUSTOTAL_API_KEY', '')
NEWS_API_KEY = os.environ.get('NEWS_API_KEY', '')

# إعدادات البريد التصيدي
...
limiter = Limiter(
    ...
    storage_uri="memory://"  # استخدام الذاكرة المؤقتة (مناسب للتجربة)
)
